...
class ProfilePersonalForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = ['avatar','tagline','bio','location','birth_year','mbti','interests','is_available','is_public','theme_color']
        widgets = {
...
class ProjectForm(forms.ModelForm):
    class Meta:
        model = Project
        fields = ['title','description','emoji','status','project_url','github_url','technologies','role','duration','looking_for_collaborators','thumbnail']
        widgets = {
...
class ToolForm(forms.ModelForm):
    class Meta:
        model = Tool
        fields = ['name','emoji','category','description','url']
        widgets = {
            'name': forms.TextInput(attrs={'class': INPUT}),
